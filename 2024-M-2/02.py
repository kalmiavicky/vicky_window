...
def anal_mk1_data(df_taipei_mk1, output_dir='analy_chiinhwang_imgs'):
    ...
    回傳:
    - all_descr: 全部資料的描述性統計。
    - descr: 特徵欄位 '平均價(元/公斤)' 的描述性統計。
    - box_plot: 箱形圖的檔案路徑。
    - skew: 偏態的描述。
    - kurt: 峰度的描述。
    - distribution_plot: 常態分布圖的檔案路徑。
    """
    ...
    try:
        print("特徵欄位: 平均價(元/公斤)")
        print(anal_data.head())  # 列印前幾行檢查內容
